...
class GameGrid:
   ...
   def __init__(self, grid_h, grid_w):
      ...
      self.line_color = Color(0, 255, 255)
      self.boundary_color = Color(0, 255, 255)
   ...
   def draw_grid(self):
      ...
      self.drawScore(self.point)
      self.show_next()
      self.hold_tetromino_box()
   ...
   def show_next(self):
      ...
      stddraw.square(15.8, 12, 3)
      next = "Next Tetromino"
      stddraw.setPenColor(Color(255, 255, 255))
      stddraw.text(15.8, 14.1, next)

   def drawScore(self, point=0):
      stddraw.setPenColor(self.boundary_color)
      stddraw.rectangle(13.3, 16, 5, 1)
      stddraw.setPenColor(Color(255, 255, 255))
      self.score = "Score: " + str(point)
      stddraw.text(15.8, 16.5, self.score)

   def hold_tetromino_box(self):
      hold_text = "Hold"
      stddraw.setPenColor(Color(255, 255, 255))
      stddraw.text(15.8, 7.8, hold_text)
      stddraw.setPenColor(self.boundary_color)
      stddraw.square(15.8, 5.6, 3)
